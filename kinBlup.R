#'kin.blup4.4
#'
#'@param data see "rrBLUP"
#'@param geno see "rrBLUP"
#'@param pheno see "rrBLUP"
#'@param GAUSS see "rrBLUP"
#'@param K see "rrBLUP"
#'@param fixed see "rrBLUP"
#'@param covariate see "rrBLUP"
#'@param PEV see "rrBLUP"
#'@param n.core see "rrBLUP"
#'@param theta.seq see "rrBLUP"
#'@param reduce see "rrBLUP"
#'@param R see "rrBLUP"
#'
#'@export
